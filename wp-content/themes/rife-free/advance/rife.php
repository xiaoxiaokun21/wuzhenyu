...
.top_bar_button.try-button {
	...
	function rating_notice(){
		...
		if($display_rating_notice){
			...
			//text
			echo '<p>'.esc_html( 'Thank you for using our Rife Free Theme, we hope everything is working good for you.' ).'</p>';
//			echo '<p>'.esc_html( 'Have you seen our reviews? You guys rock &amp; your reviews do help us a ton!' ).'</p>';
			echo '<p>'.esc_html( 'If you have spare 2 minutes please rate Rife Free Theme. If not, no big deal, just keep on rocking :-)' ).'</p>';
			echo '<p>'.esc_html( 'Daniel &amp; Air. from Apollo13Themes.' ).'</p>';

			//links
			echo '<p class="links">';

			echo '<a href="https://wordpress.org/support/theme/rife-free/reviews/#new-post" target="_blank">'.esc_html( 'Rate Rife Free' ).'</a> | ';
