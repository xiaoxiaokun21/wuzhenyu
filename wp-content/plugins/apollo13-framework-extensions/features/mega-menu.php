...
class A13fe_Admin_Edit_Menu_Walker extends Walker_Nav_Menu {
    ...
    <div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo esc_attr($item_id); ?>">
        ...
        <fieldset class="a13-megamenu-options"><legend><?php esc_html_e( 'Mega menu options', 'apollo13-framework-extensions' ); ?></legend>
        ...
        <?php do_action( 'apollo13framework_edit_menu_walker_print_item_settings', $item, $depth, $args, $id, $item_id ); ?>
...
add_filter( 'wp_edit_nav_menu_walker', 'a13fe_admin_change_walker_class', 10, 2 );
