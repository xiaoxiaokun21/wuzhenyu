	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'raw' => sprintf(__( 'This works only with the <a href="%s">Rife Pro theme</a>. The Rife Free theme will display slider instead.', 'apollo13-framework-extensions' ), esc_url( 'https://apollo13themes.com/rife/' ) ),
