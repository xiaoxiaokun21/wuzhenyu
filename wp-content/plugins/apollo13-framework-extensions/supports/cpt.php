...
function a13fe_register_custom_post_types() {
	...
	$labels = array(
		...
		'singular_name'      => __( 'Man', 'apollo13-framework-extensions' ),
		'add_new'            => _x( 'Add New', 'man', 'apollo13-framework-extensions' ),
		'add_new_item'       => _x( 'Add New', 'man', 'apollo13-framework-extensions' ),
