...
/*global Modernizr, YT, $f, _V_, TweenMax, Linear, Power2, Sine,  TimelineLite, A13FRAMEWORK */
(function($){
    "use strict";
    ...
    var a13slider = function(SliderOptions){
		...
		var prepareEnv = function(){
			...
			//prepare play button
			if (p_bar_enabled){
				TweenMax.set(play_button.find('.circle'), {scale:0});
			}
        ...
        videoStateChange = function(event, playerId){
            ...
            * */
            ...
            if(state === 1){
				...
				//Vimeo player thorws random play state after it is paused and slide is changed. Not sure why it happens.
